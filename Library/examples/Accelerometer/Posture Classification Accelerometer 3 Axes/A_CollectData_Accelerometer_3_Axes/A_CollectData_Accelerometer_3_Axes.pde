//*********************************************
//  A_CollectData_Accelerometer_3_Axes : Collects data from accelerometer from Arduino
//
...
//
//  You can find this sketch in the Arduino folder from this Example.
//
...
//
//  To increase the label press '/' (max 10 labels)
